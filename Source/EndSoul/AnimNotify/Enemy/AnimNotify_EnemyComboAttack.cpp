...
#include "AnimNotify_EnemyComboAttack.h"
#include "GameFramework/Character.h"
#include "kismet/GameplayStatics.h"
#include "../../Player/DamageType/ComboDamageType.h"

FString UAnimNotify_EnemyComboAttack::GetNotifyName_Implementation() const
{
	return TEXT("EAttack");
}

void UAnimNotify_EnemyComboAttack::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
{
